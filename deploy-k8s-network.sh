...
sudo k3s ctr images import peer-registry-tp:local
sudo k3s ctr images import docker-image-tp:local
sudo k3s ctr images import docker-image-client:local
sudo k3s ctr images import fog-node:local
